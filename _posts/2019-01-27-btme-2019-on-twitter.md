...
There were 1,202 tweets (including retweets) with that hashtag on those dates.
...
Of those accounts using the #BTME2019 hashtag, and I think that was the official one, these are the top tweeters, those sending 5 or more tweets with that tag from January 18 to 26.
