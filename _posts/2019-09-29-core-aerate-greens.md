...
In the big scheme of things, nobody reads the ATC website. I can highlight things here all I want, but there just aren't a lot of visitors. The median visitor number per day in 2019 is 41. Let's say there are 10 people working in turf maintenance at each of the 38,000 golf courses around the world. That's 380,000 potential interested people in this kind of turfgrass information. Let's say there are 2 other people at the course who might be interested. That's another 76,000 potential readers. That's only golf! There are a lot more from sports turf and lawn care and so on. We are talking hundreds of thousands of possible readers, but on average there are 41.

I keep making notes to myself that I should spend less time writing on the blog, and instead spend more time working on things that I can charge money for. But I have a lot of things I want to say and often prefer to write about turfgrass.

I think it is pretty easy to justify doing the work necessary to produce the desired conditions at any facility, and I would hope that some of the information here at the ATC website is useful in that regard (see for example the most-read post of all time from this site, from 2009, on [Core aeration of Putting Greens...how much is enough?](https://www.blog.asianturfgrass.com/2009/07/core-aeration-of-putting-greens-how-much-is-enough.html)). At the same time, when there are standard recommendations that I think are widely known, certainly more widely-known than the barely-read content that I produce, I find it worthwhile to share and highlight some of those situations where an alternative to the standard recommendation is producing good results. 
